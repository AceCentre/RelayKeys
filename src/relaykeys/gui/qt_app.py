...
class DeviceEntryWidget(QFrame):
    def __init__(self, devname, deleteDeviceFunction):
        ...
        deleteDeviceSwitch.setIcon(QIcon(str(Path(__file__).resolve().parent.parent.parent.parent / "assets" / "icons" / "delete_icon.png")))
        ...
        deleteDeviceSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
...
class Window(QMainWindow):
    ...
    def __init__(self, args, config):
        ...
        connectionPageSwtich.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        keyboardToggleButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        mouseToggleButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        if self._show_last_n_chars > 0:
            ...
            p = label.palette()
            p.setColor(label.backgroundRole(), Qt.GlobalColor.white)
            label.setPalette(p)
            fontsize = 10
            label.setText(
        ...
        self.macroRecordSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        replayMacroSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        executeMacroSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)

        self.macroStatusLabel = QLabel()
        self.macroStatusLabel.setAlignment(Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignHCenter)
        ...
        daemonModeSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.deviceNameConnTab.setAlignment(Qt.AlignmentFlag.AlignBottom)
        ...
        bleConnectionSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        scrollAreaContainer.setFrameStyle(QFrame.Shape.WinPanel | QFrame.Shadow.Sunken)
        scrollAreaContainer.setLineWidth(3)
        scrollAreaContainer.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        ...
        addDeviceSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        refreshListSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        resetListSwitch.setFocusPolicy(Qt.FocusPolicy.NoFocus)
